            ...
            {emp.employee_code && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-0.5">{emp.employee_code}</p>
                </div>
              </div>
            )}
            {emp.position && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-0.5">{emp.position}</p>
                </div>
              </div>
            )}
            {emp.hire_date && (
            ...
            {emp.Department && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-0.5">{emp.Department.name}</p>
            ...
            {emp.Team && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-0.5">{emp.Team.name}</p>
            ...
            {emp.manager && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-0.5">{emp.manager.full_name}</p>
