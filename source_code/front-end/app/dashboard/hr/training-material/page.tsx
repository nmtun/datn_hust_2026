...
"use client";
import { Search, Plus, Edit2, Eye, Trash2, FileText, Download, BookOpen, Archive, Tags, TagIcon } from "lucide-react";
...
import MaterialQuizModal from "@/app/components/MaterialQuizModal/MaterialQuizModal";
...
function TrainingMaterialPage() {
  ...
  const [materialForQuizzing, setMaterialForQuizzing] = useState<TrainingMaterial | null>(null);
    ...
    <div>
      ...
      <div className="bg-white shadow rounded-lg">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Bắt đầu bằng cách tạo tài liệu đào tạo đầu tiên của bạn.</p>
          </div>
        ) : (
                ...
                <tr key={material.material_id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end space-x-3">
                      ...
                      <button
                        onClick={() => {
                          setMaterialForQuizzing(material);
              ...
              {selectedMaterial.quizzes && selectedMaterial.quizzes.length > 0 ? (
                <div className="space-y-2">
                  {selectedMaterial.quizzes.map((quiz) => (
                    <div key={quiz.quiz_id} className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                      <div>
      ...
      {materialForQuizzing && (
        <MaterialQuizModal
          ...
          onClose={() => {
            setIsMaterialQuizModalOpen(false);
            setMaterialForQuizzing(null);
          }}
          materialId={materialForQuizzing.material_id}
          materialTitle={materialForQuizzing.title}
          materialTags={materialForQuizzing.tags || []}
          onQuizzesUpdated={() => {
            fetchTrainingMaterials();
          }}
        />
