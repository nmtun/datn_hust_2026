  ...
  const fetchQuiz = async () => {
    try {
      ...
      if (quizData.tags && Array.isArray(quizData.tags)) {
        setSelectedTags(quizData.tags.map((tag: any) => tag.tag_id));
      }
    } catch (error: any) {
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Quiz không tồn tại</h3>
          <button
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="border border-gray-300 rounded-lg p-4 max-h-40 overflow-y-auto">
                {tags.length === 0 ? (
                  <p className="text-gray-500 text-sm">Không có tags nào khả dụng</p>
                ) : (
