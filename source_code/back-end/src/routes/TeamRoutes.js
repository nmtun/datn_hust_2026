...
router.get('/managed', authenticate, authorize("hr", "manager", "employee"), teamController.getManagedTeams);
...
router.put('/:id/add-member', authenticate, authorize("hr", "manager", "employee"), teamController.addMember);
router.put('/:id/remove-member', authenticate, authorize("hr", "manager", "employee"), teamController.removeMember);
