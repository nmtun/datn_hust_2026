...
router.post('/:materialId/attach-quiz', authenticate, authorize("hr"), trainingMaterialController.attachQuizToMaterial);
router.delete('/:materialId/detach-quiz/:quizId', authenticate, authorize("hr"), trainingMaterialController.detachQuizFromMaterial);
router.get('/:materialId/shared-tag-quizzes', authenticate, trainingMaterialController.getQuizzesBySharedTags);
