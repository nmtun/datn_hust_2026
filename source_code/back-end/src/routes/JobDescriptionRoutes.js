...
router.get('/get-all', authenticateOptional, jobdescriptionController.getAllJobDescriptions);
router.get('/get/:id', authenticateOptional, jobdescriptionController.getJobDescriptionById);
