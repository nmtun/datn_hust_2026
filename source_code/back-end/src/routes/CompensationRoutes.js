...
router.post('/create', authenticate, authorize("manager", "hr"), compensationController.createCompensation);
...
router.put('/update/:id', authenticate, authorize("manager", "hr"), compensationController.updateCompensation);
router.get('/my', authenticate, authorize("employee", "manager", "hr"), compensationController.getMyCompensation);
router.get('/employee/:userId', authenticate, authorize("manager", "hr"), compensationController.getCompensationByEmployee);
