...
router.post('/create', authenticate, authorize('manager', 'employee'), taskController.createTask);
...
router.put('/update/:id', authenticate, authorize('manager', 'employee'), taskController.updateTask);
router.put('/status/:id', authenticate, authorize('hr', 'manager', 'employee'), taskController.updateTaskStatus);
router.delete('/delete/:id', authenticate, authorize('manager', 'employee'), taskController.deleteTask);
