            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl bg-blue-500 rounded-3xl">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
                    ...
                    <div className="p-10 flex flex-col justify-center">
                        <h3 className="text-4xl md:text-5xl font-semibold mb-3 text-white">Đăng ký nhận thông tin mới nhất</h3>
                        <h4 className="text-base font-normal mb-7 text-offwhite">Nhận các cập nhật tính năng mới, xu hướng quản lý doanh nghiệp và những lời khuyên hữu ích từ các chuyên gia của chúng tôi.</h4>
                        <div className="flex gap-0">
                            <input type="Email address" name="q" className="py-4 text-sm w-full text-black bg-white rounded-l-lg pl-4" placeholder="Nhập địa chỉ email của bạn" autoComplete="off" />
