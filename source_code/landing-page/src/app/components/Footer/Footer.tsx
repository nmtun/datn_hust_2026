...
const products: ProductType[] = [
    {
        id: 1,
        link: ['Trang chủ', 'Tính năng', 'Về chúng tôi', 'Liên hệ'],
    },
    {
        id: 2,
        link: ['Hỗ trợ', 'Tài liệu', 'Ứng dụng', 'Đội ngũ']
    }
]
        ...
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite">Tầng 10, Tòa nhà ABC, 123 Đường Láng, Hà Nội</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/telephone.svg'} alt="telephone-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">+84 24 1234 5678</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-offwhite">info@quanlydoanhnghiep.vn</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>© 2024 Phần mềm Quản lý Doanh nghiệp. Bản quyền thuộc về <Link href="#" target="_blank">Công ty ABC</Link></h4>
                    <div className="flex gap-5 mt-5 lg:mt-0 justify-center lg:justify-start">
                        <h4 className='text-offwhite text-sm font-normal'><Link href="/" target="_blank">Chính sách bảo mật</Link></h4>
                        <div className="h-5 bg-bordertop w-0.5"></div>
                        <h4 className='text-offwhite text-sm font-normal'><Link href="/" target="_blank">Điều khoản sử dụng</Link></h4>
                    </div>
                </div>
